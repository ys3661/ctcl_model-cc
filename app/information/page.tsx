        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/50 border-blue-200">
            ...
            <CardContent className="space-y-4">
              ...
              <p>
                ...
                or psoriasis. Early diagnosis can be challenging due to this resemblance to common skin conditions.
              </p>
              ...
              <div className="flex justify-end mt-4">
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 border border-transparent rounded-md bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 hover:shadow-lg hover:translate-y-[-2px] transition-all duration-300 ease-in-out"
                >
          ...
          <Card className="mb-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/50 border-blue-200">
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                <li>
                  <strong>Immunohistochemistry:</strong> To identify abnormal T-cell populations and their
                  immunophenotype
                </li>
                <li>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/50 border-blue-200">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="mt-4">
                Factors associated with poorer prognosis include advanced age, large cell transformation, elevated
                lactate dehydrogenase (LDH), and significant blood involvement.
              </p>
